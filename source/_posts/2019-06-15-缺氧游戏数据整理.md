...
Sand | 3000 | `N/A` | 不需要
Carbon | 3000 | `N/A` | 不需要
Fertilizer | 3000 | `N/A` | 不需要
Brine | 2000 | `N/A` | 不需要
SaltWater | 2000 | `N/A` | 不需要
Rust | 1000 | `N/A` | 不需要
PrickleGrassSeed | 3 | `N/A` | 不需要
LeafyPlantSeed | 3 | `N/A` | 不需要
CactusPlantSeed | 3 | `N/A` | 不需要
MushroomSeed | 1 | `N/A` | 不需要
PrickleFlowerSeed | 2 | `N/A` | 不需要
OxyfernSeed | 1 | `N/A` | 不需要
ForestTreeSeed | 1 | `N/A` | 不需要
PrickleGrassSeed | 3 | `N/A` | 不需要
FieldRation | 5 | `N/A` | 不需要
BasicForagePlant | 6 | `N/A` | 不需要
LightBugBaby | 1 | `N/A` | 不需要
HatchBaby | 1 | `N/A` | 不需要
PuftBaby | 1 | `N/A` | 不需要
SquirrelBaby | 1 | `N/A` | 不需要
CrabBaby | 1 | `N/A` | 不需要
LightBugEgg | 3 | `N/A` | 不需要
HatchEgg | 3 | `N/A` | 不需要
PuftEgg | 3 | `N/A` | 不需要
SquirrelEgg | 2 | `N/A` | 不需要
BasicCure | 3 | `N/A` | 不需要
Funky_Vest | 1 | `N/A` | 不需要
CookedEgg | 3 | `6` | 不需要
Ice | 4000 | `12` | 不需要
PrickleFruit | 3 | `12` | 不需要
OilfloaterEgg | 3 | `12` | 不需要
Cuprite | 2000 | `12` | *需要*
GoldAmalgam | 2000 | `12` | *需要*
BasicFabricMaterialPlant | 3 | `24` | 不需要
SwampLilySeed | 1 | `24` | 不需要
ColdBreatherSeed | 1 | `24` | 不需要
SpiceVineSeed | 1 | `24` | 不需要
FriedMushroom | 3 | `24` | 不需要
DreckoBaby | 1 | `24` | 不需要
Pacu | 8 | `24` | 不需要
MoleEgg | 3 | `24` | 不需要
DreckoEgg | 3 | `24` | 不需要
...
SpicyTofu | 3 | `48` | 不需要
MoleBaby | 1 | `48` | 不需要
OilfloaterBaby | 1 | `48` | 不需要
Lime | 150 | `48` | *需要*
Polypropylene | 500 | `48` | *需要*
Glass | 200 | `48` | *需要*
Steel | 100 | `48` | *需要*
Ethanol | 100 | `48` | *需要*
AluminumOre | 100 | `48` | *需要*
